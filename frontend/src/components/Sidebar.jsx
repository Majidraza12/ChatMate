...
const Sidebar = () => {
    ...
    const {onlineUsers} = useAuthStore()//Actually Online users stored here -> we will use this when we implement the socket.io part
    ...
    return (
        <aside className='h-full w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200'>
            <div className='border-b border-base-300 w-full p-5'>
                ...
                <div className='mt-3 hidden lg:flex items-center'>
                ...
                {   
                    filteredUsers.map((user)=>(
                        <button
                            ...
                            {/* User Info -only visible on larger screeens */}
